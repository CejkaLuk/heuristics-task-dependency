...
class ActivityTest(unittest.TestCase):
    ...
    def test_equality_comparison(self, act_left: Activity, act_right: Activity,
        ...
        self.assertEqual(len(vars(act_left).items()), 11)
