...
class CPMInitializerTestSuite(unittest.TestCase):
    """Test that CPMDataInitializer works correctly."""
    ...
    @params((activities, correct_predecessors_ids, correct_successors_ids),
            ...
            ([], {}, {}))
    def test_init_activities(self, acts, correct_pred_ids, correct_succs_ids):
        """Tests that 'init_activities' initializes Activity instances correctly."""

        CPMActivitiesInitializer().init_activities(acts)
    ...
    def test_init_activities_provided_in_nonlist_should_fail(self):
        ...
        with self.assertRaises(TypeError, msg="Initializing activities should have failed as" +
            ...
            CPMActivitiesInitializer().init_activities({ID.from_str("1-2"): Activity("1-2", 4, 3),
